...
{
    public class SoundRecorderAsync
    {
        ...
        private CancellationTokenSource _recordingTaskTokenSource;

        private Task _writeAudioToFileTask;
        private CancellationTokenSource _writeAudioToFileTokenSource;
        ...
        public void StopRecording()
        {
            ...
            if (!_recordingTaskTokenSource.IsCancellationRequested)
                _recordingTaskTokenSource.Cancel();
            try
            {
                _recordingTask.Wait();
            }
