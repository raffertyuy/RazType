...
namespace RazSpeakerAuthentication.Helpers
{
    public class SoundRecorder
    {
        ...
        private const string AUDIO_RECORDER_FOLDER = "RazSpeakerAuthentication";
        ...
        public const string WAV_FILENAME = "/sdcard/RazSpeakerAuthentication/voice8K16bitmono.wav";
        public const string WAV_RAW_FILENAME = "/sdcard/RazSpeakerAuthentication/voice8K16bitmonoraw.wav";
